...
public class PlaynextCmd extends DJCommand
{
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        {
            event.replyWarning("Пожалуйста предоставьте название песни или URL!");
            return;
        }
    ...
    private class ResultHandler implements AudioLoadResultHandler
    {
        ...
        private void loadSingle(AudioTrack track)
        {
            ...
            {
                m.editMessage(FormatUtil.filter(event.getClient().getWarning()+" Песня (**"+track.getInfo().title+"**) не может быть больше разрешённого максимума: `"
