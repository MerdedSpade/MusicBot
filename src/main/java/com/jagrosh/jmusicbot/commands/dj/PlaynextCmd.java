...
public class PlaynextCmd extends DJCommand
{
    ...
    public PlaynextCmd(Bot bot)
    {
        ...
        this.help = "воспроизводит одну песню следующей";
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        {
            event.replyWarning("Предоставьте название песни или URL!");
            return;
        }
    ...
    private class ResultHandler implements AudioLoadResultHandler
    {
        ...
        private void loadSingle(AudioTrack track)
        {
            ...
            {
                m.editMessage(FormatUtil.filter(event.getClient().getWarning()+" Эта песня (**"+track.getInfo().title+"**) длиннее разрешённого максимума: `"
