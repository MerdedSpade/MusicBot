...
public class SetnameCmd extends OwnerCommand
{
    ...
    {
        this.name = "setname";
        this.help = "устанавливает имя бот";
        this.arguments = "<имя>";
    ...
    protected void execute(CommandEvent event) 
    {
        ...
        {
            event.reply(event.getClient().getError()+" Имя можно менять только дважды в час!");
        }
        catch(Exception e) 
        {
            event.reply(event.getClient().getError()+" Это имя недействительно!");
        }
    }
}
